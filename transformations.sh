...
# nik2img.py OSNT02Blend.xml gb.png --srs 27700 --dimensions 700 1300 0 0 700000 1300000 -w pgw

# render using Mapnik (Stornoway Example)
nik2img.py OSNT02Blend.xml gb.png --srs 27700 --dimensions 500 500 142500 933000 142600 933100 -w pgw